...
|                         |                                                     |
| :------------------------ | :---------------------------------------------------- |
| **Titre du projet**     | Agent IA Immo                                       |
| **Binôme**             | Jonathan, Steve, Cyril                              |
| **Date de début**      | 09.03.2026                                          |
| **Date de livraison**   | 13.03.2026                                          |
| **Lien dépôt GitHub** | https://github.com/VestiC1/Projet-Agent-IA-Immo.git |
...
Développer un agent IA qui permet de faire du conseil immobilier avec l'utilisation d'outils externe

### 2.2 Problématique / besoin utilisateur

Assister les agents immobilier dans leur recherche de tous les jours (estimation, historique, environnement immobilier)
...
- [X] Informations sur une commune (écoles, transports, commerces)
- [] Conseils personnalisés (investissement, achat, location)
- [X] Historique des conversations
- [X] Autre (précisez) : parce que qui peut le plus peut le moins
...
estimation, historique, environnement immobilier.
